...
static char font[] = "RecMonoCasual Nerd Font:size=13";
static char dmenufont[] = "RecMonoCasual Nerd Font:size=13";
static const char *fonts[] = {
    font, "NotoColorEmoji:pixelsize=25:antialias=true:autohint=true"};
...
static char *colors[][3] = {
    ...
    /*                    text             background     not used but cannot be
       empty */
    [SchemeStatus] = {selbordercolor, normbgcolor,
                      "#000000"}, // Statusbar right
...
const char *spcmd4[] = {"v2raya", NULL};
const char *spcmd5[] = {"virtualbox", NULL};
static Sp scratchpads[] = {
    /* name            cmd  */
    {"spterm", spcmd1}, {"spobs", spcmd2},  {"spyesplaymusic", spcmd3},
    {"spvpn", spcmd4},  {"spvbox", spcmd5},
};
...
static const Rule rules[] = {
    ...
    {"v2raya", NULL, NULL, SPTAG(3), 1, 0, 1, -1},
...
#define DMENU                                                                  \
  "dmenu -i -l 50 -fn 'RecMonoCasual Nerd Font:size=13' -nb '#222222' -nf "    \
  "'#bbbbbb' -sb '#ffd700' -sf '#005577' -p bookmarks:"
#define ADDBOOKMARK                                                            \
  {                                                                            \
    .v = (const char *[]) { "bookmarkadd", NULL }                              \
  }
#define OPENBOOKMARK                                                           \
  {                                                                            \
    .v = (const char *[]) { "bookmarkdisplay", NULL }                          \
  }
#define SCREENSHOT                                                             \
  {                                                                            \
...
#define READPDF                                                                \
  {                                                                            \
    .v = (const char *[]) { "readpdf", NULL }                                  \
  }
#define COPYSYMBOLS                                                            \
  {                                                                            \
    .v = (const char *[]) { "dmenusymbols", NULL }                             \
  }
